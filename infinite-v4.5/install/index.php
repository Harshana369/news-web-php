                                        ...
                                        <div class="tab_1">
                                            ...
                                            <div class="form-group">
                                                <div class="alert alert-success" role="alert" style="font-size: 15px;">
                                                    ...
                                                    <br><br>
                                                    If you see the "Invalid License Code" error, please read this article:&nbsp;<a href="https://codingest.net/knowledge-base?content=145" target="_blank"><strong>Invalid License Code</strong></a>
                                                </div>
                                            </div>
