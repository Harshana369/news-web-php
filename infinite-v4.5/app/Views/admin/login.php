...
<head>
    ...
    <link rel="stylesheet" href="<?= base_url('assets/admin/css/admin-4.5.css'); ?>">
    <style>.error-message p {color: #dc3545 !important; text-align: center}.alert-danger {display: block;width: 100%; padding: 8px;}.alert-danger button{display: none}</style>
</head>
