            ...
            <form action="<?= base_url('Admin/preferencesPost'); ?>" method="post">
                ...
                <div class="box-body">
                    ...
                    <div class="form-group">
                        ...
                        <?= formRadio('sticky_sidebar', 1, 0, trans("enable"), trans("disable"), $generalSettings->sticky_sidebar); ?>
                    </div>
                    <div class="form-group">
            ...
            <form action="<?= base_url('Admin/fileUploadSettingsPost'); ?>" method="post">
                ...
                <div class="box-body">
                    ...
                    <div class="form-group">
                        ...
                        <div class="row">
                            <div class="col-sm-12">
                                <input id="tag-input" type="text" name="allowed_file_extensions" value="<?= str_replace('"', '', $generalSettings->allowed_file_extensions ?? ''); ?>" class="form-control tags-input"/>
