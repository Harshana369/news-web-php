...
<script>
    ...
    function loadMoreUsers() {
        ...
        $.ajax({
            type: 'POST',
            url: InfConfig.baseUrl + '/Ajax/loadMoreUsers',
            data: data,
            success: function (response) {
                setTimeout(function () {
                    if (response.result == 1) {
                        $("#userTableContainer tbody").append(response.htmlContent);
                    }
    ...
    function loadMoreSubscribers() {
        ...
        $.ajax({
            type: 'POST',
            url: InfConfig.baseUrl + '/Ajax/loadMoreSubscribers',
            data: data,
            success: function (response) {
                setTimeout(function () {
                    if (response.result == 1) {
                        $("#subscriberTableContainer tbody").append(response.htmlContent);
                    }
