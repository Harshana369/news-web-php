                        ...
                        <div class="form-group" style="margin-bottom: 45px;">
                            <div class="row">
                                <div class="col-md-4 col-sm-12" style="margin-bottom: 15px;">
                                    ...
                                    <div class="row">
                                        <div class="col-sm-12">
                                            <div style="width:<?= getLogoSize('width'); ?>px; height:<?= getLogoSize('height'); ?>px;">
                                                <?php if (!empty($generalSettings->logo_path)): ?>
                                                    <img src="<?= base_url($generalSettings->logo_path); ?>" alt="" width="<?= getLogoSize('width'); ?>" height="<?= getLogoSize('height'); ?>" style="max-width: 500px; object-fit: contain">
                                                <?php else: ?>
                                                    <img src="<?= base_url('assets/img/logo.png'); ?>" alt="" width="<?= getLogoSize('width'); ?>" height="<?= getLogoSize('height'); ?>" style="max-width: 500px; object-fit: contain">
                                                <?php endif; ?>
                                            </div>
                                        </div>
                                    </div>
                                        ...
                                        <div class="col-sm-3">
                                            <div style="width:<?= getLogoSize('width'); ?>px; height:<?= getLogoSize('height'); ?>px;">
                                                <?php if (!empty($generalSettings->logo_darkmode_path)): ?>
                                                    <img src="<?= base_url($generalSettings->logo_darkmode_path); ?>" alt="" width="<?= getLogoSize('width'); ?>" height="<?= getLogoSize('height'); ?>" style="max-width: 500px; background-color: #f7f7f7; object-fit: contain">
                                                <?php else: ?>
                                                    <img src="<?= base_url('assets/img/logo-mobile.png'); ?>" alt="" width="<?= getLogoSize('width'); ?>" height="<?= getLogoSize('height'); ?>" style="max-width: 500px; background-color: #f7f7f7;object-fit: contain">
                                                <?php endif; ?>
                                            </div>
                                        </div>
                                    </div>
                                        ...
                                        <div class="row" style="margin-top: 15px;">
                                            <div class="col-sm-12">
                                                <a class='btn btn-success btn-sm btn-file-upload'>
                                                    ...
                                                    <input type="file" name="favicon" size="40" accept=".png, .jpg, .webp, .jpeg, .gif" onchange="$('#upload-file-info3').html($(this).val().replace(/.*[\/\\]/, ''));">
                                                </a>
                                            </div>
                                        </div>
                                ...
                                <div class="col-md-4 col-sm-12">
                                    ...
                                    <div class="row" style="max-width: 400px; margin-bottom: 15px;">
                                        <div class="col-sm-12 col-md-6">
                                            ...
                                            <input type="number" name="logo_width" class="form-control" value="<?= getLogoSize('width'); ?>" min="10" max="500">
                                        </div>
                                        <div class="col-sm-12 col-md-6">
                                            <span><?= trans("height"); ?>(px)</span>
                                            <input type="number" name="logo_height" class="form-control" value="<?= getLogoSize('height'); ?>" min="10" max="500">
                                        </div>
                                    </div>
                                </div>
                                <div class="col-sm-12">
