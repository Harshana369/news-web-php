<table role="presentation" border="0" cellpadding="0" cellspacing="0" style="margin-top: 10px;">
    <tr>
        <td class="content-block" style="text-align: center;width: 100%;">
            <?php $socialLinks = getSocialLinksArray($settings);
...
<div class="footer">
    <table role="presentation" border="0" cellpadding="0" cellspacing="0">
        ...
        <?php if (!empty($subscriber_token)): ?>
            <tr>
                <td class="content-block">
                    <?= trans("dont_want_receive_emails"); ?> <a href="<?= base_url(); ?>/unsubscribe?token=<?= esc($subscriber_token); ?>"><?= trans("unsubscribe"); ?></a>
                </td>
            </tr>
        <?php endif; ?>
    </table>
