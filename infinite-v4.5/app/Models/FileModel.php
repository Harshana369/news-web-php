...
class FileModel extends BaseModel
{
    ...
    */
    ...
    {
        return $this->builderImages->where('id', clrNum($id))->get()->getRow();
    }
    ...
    public function getMoreImages($lastId, $limit)
    {
        ...
        return $this->builderImages->where('id <', clrNum($lastId))->orderBy('id', 'DESC')->get($limit)->getResult();
    }
    ...
    */
    ...
    public function getMoreFiles($lastId, $limit)
    {
        ...
        return $this->builderFiles->where('id <', clrNum($lastId))->orderBy('id', 'DESC')->get($limit)->getResult();
    }
