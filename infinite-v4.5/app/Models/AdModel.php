...
class AdModel extends BaseModel
{
    ...
    {
        return $this->builder->where('lang_id', clrNum($langId))->get()->getResult();
    }
    ...
    {
        $row = $this->builder->where('lang_id', clrNum($langId))->where('ad_space', cleanStr($adSpace))->get()->getRow();
        if (!empty($row)) {
            return $row;
        }
        $data = [
        ...
        return $this->builder->where('lang_id', clrNum($langId))->where('ad_space', cleanStr($adSpace))->get()->getRow();
    }
