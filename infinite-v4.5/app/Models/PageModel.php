...
class PageModel extends Model
{
    ...
    {
        return $this->builder->where('lang_id', clrNum($this->activeLangId))->orderBy('page_order')->get()->getResult();
    }
    ...
    {
        return $this->builder->where('lang_id', clrNum($langId))->where('slug', cleanSlug($slug))->get()->getRow();
    }
