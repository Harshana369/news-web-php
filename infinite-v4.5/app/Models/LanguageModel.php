...
class LanguageModel extends Model
{
    ...
    public function addLanguageSettings($langId)
    {
        $settings = [
            ...
            'copyright' => "Copyright 2025 Infinite - All Rights Reserved."
        ];
    ...
    public function addLanguagePages($langId)
    {
        ...
        $page = [
            'lang_id' => $langId, 'title' => "Contact", 'slug' => "contact", 'page_description' => "Infinite Contact Page", 'page_keywords' => "infinite, contact, page", 'is_custom' => 0, 'page_content' => "", 'page_order' => 1, 'page_active' => 1, 'title_active' => 1, 'breadcrumb_active' => 1, 'right_column_active' => 0, 'need_auth' => 0, 'location' => "header", 'parent_id' => 0
        ];
        $this->db->table('pages')->insert($page);
        $page = [
            'lang_id' => $langId, 'title' => "Terms & Conditions", 'slug' => "terms-conditions", 'page_description' => "Terms & Conditions Page", 'page_keywords' => "infinite, terms, conditions, page", 'is_custom' => 0, 'page_content' => "", 'page_order' => 1, 'page_active' => 1, 'title_active' => 1, 'breadcrumb_active' => 1, 'right_column_active' => 0, 'need_auth' => 0, 'location' => "footer", 'parent_id' => 0
        ];
        $this->db->table('pages')->insert($page);
    }
