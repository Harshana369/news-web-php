...
(1, 1, 'layout_2', 0, 'admin', 'America/New_York', 1, '#0494b1', 1, 1, 0, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 'swift', 'smtp', 'tls', NULL, '587', NULL, NULL, 'Infinite', 'noreply@domain.com', NULL, NULL, NULL, 0, NULL, NULL, 12, 9, 1, 1, 1, 1, 1, 1, 0, 0, 30, NULL, NULL, 0, 1800, 0, 'Coming Soon!', 'Our website is under construction. We\'ll be here soon with our new awesome site.', 0, 'weekly', 'server_response', 'automatically', 1, 1, NULL, NULL, NULL, 'jpg,jpeg,png,gif,svg,csv,doc,docx,pdf,ppt,psd,mp4,mp3,zip', NULL, '4.3');
